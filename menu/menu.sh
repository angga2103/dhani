...
Name=$(curl -sS https://raw.githubusercontent.com/angga2103/permission/main/ipmini | grep $MYIP | awk '{print $2}')
...
userscript=$(curl -sS https://pastebin.com/raw/Xuxjx1jV | awk '{print $1}')
emailscript=$(curl -sS https://pastebin.com/raw/Xuxjx1jV | awk '{print $2}')
tokenscript=$(curl -sS https://pastebin.com/raw/Xuxjx1jV | awk '{print $3}')
userkey=$(curl -sS https://pastebin.com/raw/Xuxjx1jV | awk '{print $1}')
emailkey=$(curl -sS https://pastebin.com/raw/Xuxjx1jV | awk '{print $2}')
tokenkey=$(curl -sS https://pastebin.com/raw/Xuxjx1jV | awk '{print $3}')
if [[ $kode == $web ]]; then
MYIP=$(curl -sS ipv4.icanhazip.com)
...
madmin=$(curl -sS https://raw.githubusercontent.com/angga2103/permission/main/ipmini | grep $MYIP | awk '{print $5}')
checking_sc
cd
