...
sldns() {
wget --no-check-certificate https://raw.githubusercontent.com/angga2103/dhani/main/slowdns/installsl.sh && chmod +x installsl.sh && ./installsl.sh
}
res1() {
wget --no-check-certificate https://raw.githubusercontent.com/angga2103/dhani/main/install/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
#res2() {
...
echo -e "$COLOR1└──────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌──────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│  [ 1 ]  \033[1;37mDomain xxx.kingvpn.my.id       ${NC}"
echo -e "$COLOR1│  "
