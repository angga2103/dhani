...
sldns() {
wget --no-check-certificate https://raw.githubusercontent.com/angga2103/angga2103/angga2103/dhani/main/slowdns/installsl.sh && chmod +x installsl.sh && ./installsl.sh
}
res1() {
