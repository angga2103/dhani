...
userscript=$(curl -sS https://pastebin.com/raw/EYEXSXEN | awk '{print $1}')
emailscript=$(curl -sS https://pastebin.com/raw/EYEXSXEN | awk '{print $2}')
tokenscript=$(curl -sS https://pastebin.com/raw/EYEXSXEN | awk '{print $3}')
userkey=$(curl -sS https://pastebin.com/raw/EYEXSXEN | awk '{print $1}')
emailkey=$(curl -sS https://pastebin.com/raw/EYEXSXEN | awk '{print $2}')
tokenkey=$(curl -sS https://pastebin.com/raw/EYEXSXEN | awk '{print $3}')
function tambahip2(){
author=$(cat /etc/profil)
superadmin=$(curl -sS https://raw.githubusercontent.com/angga2103/permission/main/ipmini | grep $MYIP | awk '{print $7}')
